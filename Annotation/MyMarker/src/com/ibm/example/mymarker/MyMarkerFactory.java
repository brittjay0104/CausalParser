...
public class MyMarkerFactory {
    ...
    throws CoreException {
            ...
            File currentFile = res.getFullPath().toFile();
            
            marker = res.createMarker(MARKER);
            
            if (currentFile.getName().equals("RealDistributionAbstractTest.java")){
            	marker.setAttribute(IMarker.LINE_NUMBER, 351);
            	marker.setAttribute(IMarker.MESSAGE, "Test failed here.");
            }
